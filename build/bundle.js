...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t4 = claim_text(span1_nodes, "(current)");
    ...
    // (16:6) {#each organs as organ, inx}
    function create_each_block(ctx) {
    	let tr;
    	let th;
    	let t0_value = /*inx*/ ctx[3] + 1 + "";
    	let t0;
    	let t1;
    	let td0;
    	let t2_value = /*organ*/ ctx[1].name + "";
    	let t2;
    	let t3;
    	let td1;
    	let t4_value = /*organ*/ ctx[1].region + "";
    	let t4;
    	let t5;
    	let td2;
    	let t6_value = /*organ*/ ctx[1].score + "";
    	let t6;
    	let t7;
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(th, file$2, 17, 10, 342);
    			add_location(td0, file$2, 18, 10, 384);
    			add_location(td1, file$2, 19, 10, 417);
    			add_location(td2, file$2, 20, 10, 452);
    			add_location(tr, file$2, 16, 8, 326);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*organs*/ 1 && t2_value !== (t2_value = /*organ*/ ctx[1].name + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*organs*/ 1 && t4_value !== (t4_value = /*organ*/ ctx[1].region + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*organs*/ 1 && t6_value !== (t6_value = /*organ*/ ctx[1].score + "")) set_data_dev(t6, t6_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:6) {#each organs as organ, inx}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t4 = claim_text(th2_nodes, "Region");
    			th2_nodes.forEach(detach_dev);
    			t5 = claim_space(tr_nodes);
    			th3 = claim_element(tr_nodes, "TH", { scope: true });
    			var th3_nodes = children(th3);
    			t6 = claim_text(th3_nodes, "Score");
    		...
    		h: function hydrate() {
    			...
    			add_location(th0, file$2, 8, 8, 110);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$2, 9, 8, 142);
    			attr_dev(th2, "scope", "col");
    			add_location(th2, file$2, 10, 8, 177);
    			attr_dev(th3, "scope", "col");
    			add_location(th3, file$2, 11, 8, 214);
    			add_location(tr, file$2, 7, 6, 96);
    			add_location(thead, file$2, 6, 4, 81);
    			add_location(tbody, file$2, 14, 4, 273);
    			attr_dev(table, "class", "table");
    			add_location(table, file$2, 5, 2, 54);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("organs" in $$props) $$invalidate(0, organs = $$props.organs);
    	};

    	$$self.$capture_state = () => ({ organs });
    ...
    class Home extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { organs: 0 });
    		...
    		if (/*organs*/ ctx[0] === undefined && !("organs" in props)) {
    			console.warn("<Home> was created without expected prop 'organs'");
    		}
    	}
    ...
    const userToken = writable(0);

    /* src\components\Login.svelte generated by Svelte v3.31.0 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			small = element("small");
    			t3 = text("We'll never share your\r\n      email with anyone else.");
    			t4 = space();
    			div1 = element("div");
    		...
    		l: function claim(nodes) {
    			form = claim_element(nodes, "FORM", { id: true });
    			...
    			small = claim_element(div0_nodes, "SMALL", { id: true, class: true });
    			var small_nodes = children(small);
    			t3 = claim_text(small_nodes, "We'll never share your\r\n      email with anyone else.");
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*phone*/ ctx[0]);
    			append_dev(div0, t2);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div3, "click", /*login*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*phone*/ 1 && input0.value !== /*phone*/ ctx[0]) {
    				set_input_value(input0, /*phone*/ ctx[0]);
    			}
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, userToken, $$value => $$invalidate(5, $userToken = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const login = async () => {
    		await fetch("https://api-data-chellenge.herokuapp.com/user/login", {
    			method: "POST",
    			...
    			set_store_value(userToken, $userToken = data.token, $userToken);
    		});
    	};
    	...
    	return [phone, password, login, input0_input_handler, input1_input_handler];
    }
    ...
    /* src\components\Apps.svelte generated by Svelte v3.31.0 */
    const file$4 = "src\\components\\Apps.svelte";

    // (22:0) {#if apps}
    function create_if_block$1(ctx) {
    	let h1;
    	let t_value = /*apps*/ ctx[0]._id + "";
    	let t;
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(h1, file$4, 22, 2, 459);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*apps*/ 1 && t_value !== (t_value = /*apps*/ ctx[0]._id + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$6(ctx) {
    	let if_block_anchor;
    	let if_block = /*apps*/ ctx[0] && create_if_block$1(ctx);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		await fetch("https://api-data-chellenge.herokuapp.com/app/all", {
    			method: "GET",
    			headers: { "auth-token": $userToken }
    		}).then(response => {
    			return response.json();
    		}).then(data => {
    			$$invalidate(0, apps = data);
    		});
    	});
    	...
    	$$self.$capture_state = () => ({ onMount, userToken, apps, $userToken });
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const home_changes = {};
    			if (dirty & /*name*/ 1) home_changes.name = /*name*/ ctx[0];
    			if (dirty & /*organs*/ 4) home_changes.organs = /*organs*/ ctx[2];
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			var h1_nodes = children(h1);
    			t0 = claim_text(h1_nodes, "Log in to continue");
    			h1_nodes.forEach(detach_dev);
    ...
    // (59:8) <Route path="/apps">
    function create_default_slot_1(ctx) {
    	let apps;
    	let current;
    	apps = new Apps({ $$inline: true });
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			claim_component(apps.$$.fragment, nodes);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, $userToken, name, organs*/ 29) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let $userToken;
    	validate_store(userToken, "userToken");
    	component_subscribe($$self, userToken, $$value => $$invalidate(3, $userToken = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	onMount(async () => {
    		fetch("https://api-data-chellenge.herokuapp.com/organ").then(response => {
    			return response.json();
    		}).then(data => {
    			$$invalidate(2, organs = data);
    		});
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("name" in $$props) $$invalidate(0, name = $$props.name);
    		if ("url" in $$props) $$invalidate(1, url = $$props.url);
    		if ("organs" in $$props) $$invalidate(2, organs = $$props.organs);
    	};
    	...
    	return [name, url, organs, $userToken];
    }
